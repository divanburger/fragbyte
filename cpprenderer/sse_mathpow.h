// By José Fonseca
// Code from: http://jrfonseca.blogspot.com/2008/09/fast-sse2-pow-tables-or-polynomials.html
...
inline __m128 pow_ps(__m128 x, __m128 y) {
   return exp_poly_ps(_mm_mul_ps(log_poly_ps(x), y));
}